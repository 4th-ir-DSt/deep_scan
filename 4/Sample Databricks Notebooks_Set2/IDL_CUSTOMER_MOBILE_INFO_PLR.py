...
dbutils.widgets.dropdown("sfIDLTable", "customer_mobile_info_plr", 
                         ["customer_mobile_info_plr"], "Snowflake table ")
...
nbName   = "Prod_IDL_CUSTOMER_MOBILE_INFO_PLR"
tz       = timezone('EST')
...
#Source CDM table
cdm_table      = 'customer_mobile_info_plr'
...
if delta == '*':
  ...
  loadDate = curSTAGE.execute("SELECT MAX(CAST(CdmLoadDate AS STRING)) FROM {}.{}".format(schemaSTAGE, sfTable)).fetchone()[0]
