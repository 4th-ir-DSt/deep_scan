...
dbutils.widgets.dropdown("sfIDLTable", "customer_address_info_plr", 
                         ["customer_address_info_plr"], "Snowflake table ")
...
nbName   = "Prod_IDL_CUSTOMER_ADDRESS_INFO_PLR"
tz       = timezone('EST')
...
#Source CDM table
cdm_table      = 'customer_address_info_plr'
