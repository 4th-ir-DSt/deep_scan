...
dbutils.widgets.dropdown("sfIDLTable", "DIM_DATE_FISCAL_BWW",
                         ["DIM_DATE_FISCAL_BWW"], "Snowflake table ")
...
df = sqlContext.read.format('com.databricks.spark.csv')\
              ...
              .load("adl://ibue2prod01udpadls1.azuredatalakestore.net/landing/bww/db/bdw/dim_date/batch/processed/")
