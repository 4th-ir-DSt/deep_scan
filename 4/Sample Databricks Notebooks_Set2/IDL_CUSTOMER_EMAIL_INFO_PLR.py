...
dbutils.widgets.dropdown("sfIDLTable", "customer_email_info_plr", 
                         ["customer_email_info_plr"], "Snowflake table ")
...
nbName   = "Prod_IDL_CUSTOMER_EMAIL_INFO_PLR"
tz       = timezone('EST')
...
#Source CDM table
cdm_table      = 'customer_email_info_plr'
