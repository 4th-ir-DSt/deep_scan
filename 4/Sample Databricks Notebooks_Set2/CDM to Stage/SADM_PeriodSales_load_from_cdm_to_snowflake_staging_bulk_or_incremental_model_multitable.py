...
dbutils.widgets.dropdown("Warehouse", "PROD_ETL_WH", 
                         ["LARGE_WH", "LOAD_WH","PROD_ETL_WH"], "Snowflake IDL Warehouse Env ")
...
#cdmtablelist = ["fin_glsales_plr","fin_gltrans_plr","fin_fran_sales_plr","store_plr","loc_ownership_status_plr","loc_temp_closure_plr"]
#cdmtablelist = ["store_plr","loc_ownership_status_plr","loc_temp_closure_plr"]
#cdmtablelist = ["fin_glsales_plr","fin_gltrans_plr","fin_fran_sales_plr"]
cdmtablelist = ["fin_glsales_plr"]
