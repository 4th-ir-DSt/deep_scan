...
dbutils.widgets.dropdown("DataBricks", "cdm_prod", 
                         ["cdm_qa", "cdm_prod","cdm_dev","cdm_uat"], "Databricks IDL database Env ")
...
dbutils.widgets.dropdown("databaseSTAGE", "CDM", 
                         ["CDM_DEV","CDM_TEST","STAGING","TMP","CDM","CDM_UAT"], "Snowflake STAGE database Env ")
...
cdmtablelist = ["LOC_STORE_PLR","LOC_DMA_PLR","LOC_OWNERSHIP_STATUS_PLR","LOC_TEMP_CLOSURE_PLR","LOC_OWNER_PLR","LOC_REMODEL_PLR", "LOC_DIVISION_PLR"]

#cdmtablelist = ["LOC_STORE_PLR"]
#cdmtablelist = ["LOC_DMA_PLR"]
