...
dbutils.widgets.dropdown("sfIDLTable", "loyalty_membership_plr", 
                         ["loyalty_membership_plr"], "Snowflake table ")
...
#Source CDM table
cdm_table      = 'loyalty_membership_plr'
...
if delta == '*':
  loadDate = 0
  df = sqlContext.sql("SELECT * FROM cdm_prod.{}".format(cdm_table))
