...
# MAGIC # Introduction
# MAGIC <table>
# MAGIC   <tr><td><b>Notebook Name</b></td><td>load_bed_dbdt_sqdw</td></tr>
# MAGIC   <tr><td><b>One Liner</b></td><td>Loading data from conformed with batch effective date to synapse staging table</td></tr>
# MAGIC   <tr><td><b>Author</b></td><td>Framework</td></tr>
# MAGIC   <tr><td><b>Creation Date</b></td><td>2021/04/21</td></tr>
# MAGIC </table>
# MAGIC 
# MAGIC 
# MAGIC <table>
...
# DBTITLE 1,Add batch effective datetime condition to whereExpression
batchEffectiveDatetimeStr = "'" + str(batchEffectiveDatetime) + "'"
whereExpression = ' (lakeValidFromTimestamp = {0} OR lakeDeletedTimeStamp = {1} OR lakeValidToTimestamp = {2})'.format(batchEffectiveDatetimeStr, batchEffectiveDatetimeStr, batchEffectiveDatetimeStr)
