...
# MAGIC # Introduction
# MAGIC <table>
# MAGIC   <tr><td><b>Notebook Name</b></td><td>load_subscribe_Claim_Loss_Narrative_dbdt_dbdt</td></tr>
# MAGIC   <tr><td><b>One Liner</b></td><td>Loading data for Claim_Loss_Narrative table in conformed zone</td></tr>
...
SELECT 
    ...
    COALESCE(Replace(Lossnarr1, 'dc937b59892', {missing_string}), {missing_string})   AS Loss_Narrative_1,
    COALESCE(Replace(Lossnarr2, 'dc937b59892', {missing_string}), {missing_string})   AS Loss_Narrative_2,
    COALESCE(Replace(Lossnarr3, 'dc937b59892', {missing_string}), {missing_string})   AS Loss_Narrative_3,
    ...
    CASE 
        WHEN max(coalesce(movt.lakeDeletedTimestamp, main.lakeDeletedTimestamp)) IS NOT NULL 
...
try:
  ...
  viewName = 'dummy_Dummy.dummyVwClaim_Loss_Narrative'
