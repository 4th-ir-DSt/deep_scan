...
# MAGIC # Introduction
# MAGIC <table>
# MAGIC   <tr><td><b>Notebook Name</b></td><td>load_scd2_dbdt_dbdt</td></tr>
# MAGIC   <tr><td><b>One Liner</b></td><td>Loading data from delta to delta</td></tr>
# MAGIC   <tr><td><b>Author</b></td><td>Harish</td></tr>
# MAGIC   <tr><td><b>Creation Date</b></td><td>2021/10/29</td></tr>
# MAGIC </table>
# MAGIC 
# MAGIC 
# MAGIC <table>
...
# MAGIC     <td>Added hash udf registration function.
# MAGIC          <br>Updated Notebook name .
# MAGIC          <br>Updated selectDestFromSrc to selectDestFromSrcTable and writeToTarget to writeToTargetTableWithAppend.
# MAGIC          <br>Added Capture rows loaded into target object.
...
# MAGIC     <td>Added  Scd Type 2 Functionality</td>
# MAGIC   </tr>
# MAGIC     <tr>
...
try:
  applyScdType2onDest(sourceSelectWhereDF,targetObjectName,columnList,currentTs,cursor,batchTaskId,batchId,adfPipelineName,clusterId,notebookName,errorLogFileLocation)
except Exception as e:
