...
# MAGIC # Introduction
# MAGIC <table>
# MAGIC   <tr><td><b>Notebook Name</b></td><td>load_unstructuredSource_dbdt_dbdt</td></tr>
...
# DBTITLE 1,Run I series functions notebook
...
try:
  ...
  if len(joinFieldsList) > 0 :
    ...
    joinSourceDf = unstructuredSourceFunctions.getJoinSourceDf(sourceTableName
                                                   ,whereExpression
                                                   ,joinFieldsList
                                                   ,jsonStartString
                                                   ,cursor
...
try:
  ...
  errorMessage="Exception occurred while loading into target table: " + str(e)
  logError(cursor,batchTaskId,errorMessage,adfPipelineName,clusterId,notebookName,errorLogFileLocation)
  assert False  
