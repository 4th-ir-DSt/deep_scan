...
# MAGIC     <td>Changed to Include unstructuredxmlSource unstructuredxmlSource Changes.
# MAGIC          <br>Added reference tables section.
# MAGIC          <br>Updated commands with logging.
# MAGIC          <br>Updated functions and variable names and Time variables as part of rework.
# MAGIC          <br>Added function call to register Lookup Udf.
# MAGIC          <br>updated unstructuredxmlSourceintermediarydictionary name.
# MAGIC          <br>Added source object id to mark dates loaded. <br>Changed typo mistake currenTs currentTs and targetTableLocation to targetLocation.
# MAGIC          <br>Updated selectDestFromSrc to selectDestFromSrcTable and writeToTarget to writeToTargetTableWithAppend.
# MAGIC          <br>Added Cell Capture rows loaded into target object.
...
# DBTITLE 1,Run unstructuredxmlSource unstructuredxmlSource function notebook
