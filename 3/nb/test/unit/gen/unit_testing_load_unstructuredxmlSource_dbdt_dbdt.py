...
# MAGIC # Introduction
# MAGIC <table>
# MAGIC   <tr><td><b>Notebook Name</b></td><td>Unit test for unit_testing_load_unstructuredxmlSource_dbdt_dbdt</td></tr>
# MAGIC   <tr><td><b>One Liner</b></td><td>Unit test for load_unstructuredxmlSource_dbdt_dbdt notebook </td></tr>
...
try :
  ...
  outputLocation = ''
  testObject = 'notebook'
  testObjectName = 'loadunstructuredxmlSourceDbdtDbdt'
...
# MAGIC %sql
# MAGIC drop table if exists testLoadNormalDbdtDbdt_a;
# MAGIC drop table if exists Stg_testLoadNormalDbdtDbdt_b;

# COMMAND ----------

# DBTITLE 1,Remove the directory for previous runs
dbutils.fs.rm(tableInputPath + '/testLoadNormalDbdtDbdt_a',recurse=True)
dbutils.fs.rm(tableInputPath + '/Stg_testLoadNormalDbdtDbdt_b',recurse=True)

# COMMAND ----------

# DBTITLE 1,Create source delta table
# MAGIC %sql
# MAGIC create table testLoadNormalDbdtDbdt_a(
# MAGIC row_id string,
# MAGIC id     string,
...
# MAGIC Location "/mnt/dataquality/unit_tests/loadunstructuredxmlSourceDbdtDbdt/input/testLoadNormalDbdtDbdt_a";
# MAGIC 
# MAGIC -- insert data into table
# MAGIC insert into testLoadNormalDbdtDbdt_a  values('aaa','a','2020-01-01 10:10:10',20200630,'true');
# MAGIC insert into testLoadNormalDbdtDbdt_a  values('bbb','b','2020-01-02 10:10:10',20200630,'true');
# MAGIC insert into testLoadNormalDbdtDbdt_a  values('ccc','c','2020-01-03 10:10:10',20200630,'true');
# MAGIC insert into testLoadNormalDbdtDbdt_a  values('ddd','d','2020-01-04 10:10:10',20200629,'true');
# MAGIC 
# MAGIC create table Stg_testLoadNormalDbdtDbdt_b(
# MAGIC id      string,
# MAGIC row_id  string)
# MAGIC USING DELTA
# MAGIC Location "/mnt/dataquality/unit_tests/loadunstructuredxmlSourceDbdtDbdt/input/Stg_testLoadNormalDbdtDbdt_b";
...
try:
  #run cleanup script
  cleanupMetadata = open("{}LoadunstructuredxmlSourceDbdtDbdtCleanUp.sql".format(testInputPath), "r").read()
...
try:
  ...
  inputParmeter = open("{}LoadunstructuredxmlSourceDbdtDbdtDataPrep1.sql".format(testInputPath), "r").read()
  ...
  #insertion of data into object,task_object_map, object_definition and object_dates_availability tables
  dataPreparation = open("{}LoadunstructuredxmlSourceDbdtDbdtDataPrep2.sql".format(testInputPath), "r").read()
...
try:
  ...
  destinationTable = 'Stg_testLoadNormalDbdtDbdt_b' 
...
#While preparing metadata gave where condition ROW_ID = "aaa"'.So,for this where row count is 1.If count is 1 then make test case is success
try:
  #Declare variables
  executionOutputStatus = 'Mismatched'
  testCaseStatus = 'failed'
...
try:
  #execute the script and get batch_task_id and task_id
  inputParmeter = open("{}LoadunstructuredxmlSourceDbdtDbdtDataPrep3.sql".format(testInputPath), "r").read()
