...
# MAGIC 
# MAGIC #Instruction
# MAGIC <li>This notebook runs as a part of ADF pipeline test.</li>
...
# MAGIC # Introduction
# MAGIC <table>
# MAGIC   <tr><td><b>Notebook Name</b></td><td>adfMasterTest_run_notebook</td></tr>
# MAGIC   <tr><td><b>One Liner</b></td><td>Runs as a part of testing the adf_pipeline_master</td></tr>
# MAGIC   <tr><td><b>Author</b></td><td>Prathippa</td></tr>
...
# MAGIC     <td>@adfPipelineName = 'testpipeline'</td>
# MAGIC   </tr>
# MAGIC    <tr>
...
# DBTITLE 1,Task End and close connection
