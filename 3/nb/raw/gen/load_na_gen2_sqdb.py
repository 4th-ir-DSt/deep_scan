...
# MAGIC # Introduction
# MAGIC <table>
# MAGIC   <tr><td><b>Notebook Name</b></td><td>load_na_gen2_sqdb</td></tr>
# MAGIC   <tr><td><b>One Liner</b></td><td>Identify any new data in raw source objects and store the dateTime in the metadata database </td></tr>
...
# MAGIC     <td> Checked if location from metadata ended in / and removed it. Added in a / into the derived path for folder scanning.  Changed the infiledatetime column to be from passed in to the select statement. Changed functions to Camel Case, removed error_line 
# MAGIC          <br>Added default return value if all date and time directories are empty
# MAGIC          <br>Moved all function definitions to misc_functions notebook
# MAGIC          <br>Added import of json
# MAGIC          <br>Added BatchId parameter to getRawEventhubObjectLocations call</td></tr>
# MAGIC </table>
# MAGIC 
...
try :
  rawLocation = getRawEventhubObjectLocations(conn,
                                               cursor,
                                               batchId,
                                               batchTaskId,
                                               adfPipelineName,
  ...
  errorMessage = 'Exception occurred while executing the function getRawEventhubObjectLocations: ' + str(e)
...
try :
  rawObjectLatestDateTime(rawLocationDetails,
                          cursor,
                          batchTaskId,
                          adfPipelineName,
                          clusterId,
